...
public class Programme_10_TubLine_Advanced {
    ...
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angle,Baker Street,Bank,Barbican,bayswater,blackfriars,bond street," +
                ...
                // Multidimensional array of Tube lines and station
        ...
        do{
            ...
            String str = JOptionPane.showInputDialog(frame, "Enter station name between A to G ?",
                    "station Name", JOptionPane.WARNING_MESSAGE);
            String c = "";
